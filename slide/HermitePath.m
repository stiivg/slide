...
/*
 KeyPoints are the inflection points the path will go through. Each bezier segment
 uses a start Keypoint and slope and an end Keypoint and slope. The list of Keypoints and slopes
 is called the control point array.
 
 Path points are the equidistant points along the path used to define the motion along
 the path.  The trick to keeping them equidistant is to ratio them to the inverse slope 
 of the path.
...
-(void)scalePath {
    const float k_road_scale = 1 * CC_CONTENT_SCALE_FACTOR;
...
-(void) saveControlPoints {    
    NSString *filePath = @"/Users/stevengallagher/Documents/SlideGame/controlpoints.tsv";
    FILE *file;
...
-(void) saveKeyPoints {    
    NSString *filePath = @"/Users/stevengallagher/Documents/SlideGame/keypoints.tsv";
    FILE *file;
    file = fopen([filePath cStringUsingEncoding:NSUTF8StringEncoding], "w");
...
-(void) savePathPoints {    
    NSString *filePath = @"/Users/stevengallagher/Documents/SlideGame/pathpoints.tsv";
    FILE *file;
    file = fopen([filePath cStringUsingEncoding:NSUTF8StringEncoding], "w");
